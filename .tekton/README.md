...
To modify the pipelines for `llama-stack-k8s-operator` in the `rhoai-3.5-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for llama-stack-k8s-operator (rhoai-3.5-ea.1)"
